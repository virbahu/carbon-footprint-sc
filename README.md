...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/supply--chain-sustainability-orange.svg" alt="Topic">
  <img src="https://img.shields.io/badge/status-production--ready-brightgreen.svg" alt="Status">
</p>


*Measuring and reducing carbon emissions across the supply chain lifecycle*

---

## 📋 Overview

**Carbon Footprint SC** addresses a critical challenge in modern supply chain management: carbon. This implementation combines rigorous academic methodology with production-ready Python code, suitable for both research and enterprise deployment.

Built on the foundational work of **Professor Stefan Gold**, this tool provides supply chain professionals with an analytical framework that transforms raw operational data into actionable optimization decisions. Whether you're managing a single warehouse or a global multi-echelon network, this toolkit scales to your complexity.
...
Supply chain carbon is a persistent operational challenge that impacts cost, service, and working capital across the enterprise. Organizations that fail to optimize carbon typically see:
...
```bash
git clone https://github.com/virbahu/carbon-footprint-sc.git
cd carbon-footprint-sc
pip install -r requirements.txt
python carbon_footprint_sc.py
```
...
```python
# Quick start example
from carbon_footprint_sc import *
...
# See docstrings in carbon_footprint_sc.py for full parameter reference
```
...
| | |
|---|---|
| **Based on** | Professor Stefan Gold, University of Kassel |
| **Key Reference** | Gold et al. (2010) *Sustainable Supply Chain Management.* Journal of Cleaner Production |
| **Domain** | Carbon |
